...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  if([@"init" isEqualToString:call.method ]) {
      ...
      if([object isKindOfClass:[NSDictionary class]]) {
          ...
          MidtransAddress *address = [MidtransAddress addressWithFirstName:customer[@"first_name"] lastName:customer[@"last_name"] phone:@"" address:@"" city:@"" postalCode:@"" countryCode:@""];
